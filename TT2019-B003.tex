	...
	\section{\textcolor{azulescom}{Análisis.}}
		\subsection{Prototipo I.}
			...
			\subsubsection{Herramientas a usar.}
				...
				Tarjeta de video: Tarjeta integrada Intel
				Memoria RAM: 6GB
				Disco Duro: 500GB 
	...
	\section{\textcolor{azulescom}{Desarrollo.}}
		\subsection{Prototipo I.}
			...
			\subsubsection{Descripción de casos de uso.}
				...
				\begin{enumerate}
					\item \textbf{\textit{El Usuario}} o \textbf{\textit{El Sistema Externo}} realiza una petición en el navegador Google Chrome.\\
