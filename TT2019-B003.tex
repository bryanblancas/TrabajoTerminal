...
\begin{document}
	...
	\section{\textcolor{azulescom}{Introducción.}}
		...
		\subsection{Justificación.}
			Los usuarios deben de guardar las contraseñas en medios fisicos o digitales y perderlos presenta un grave problema de seguridad. La gran mayoria de servicios web han implementado una solución la cual es recordar tu usuario y contraseña para que se pueda automaticamente acceder al servicio
		...
		\subsection{Prototipo I.}
			...
			\subsubsection{Reglas del negocio.}
				{\setlength{\parindent}{12pt}
					...
					\textbf{PI\_RN1. Confidencialidad de la actividad web.} En cuanto el cliente lo indique por medio de la IU, la extensión deberá dejar de vigilar la actividad que el usuario realice en el navegador.\\
		...
		\subsection{Prototipo I.}
			...
			\subsubsection{Descripción de casos de uso.}
				...
				\begin{tabular}{ |p{3cm}||p{10cm}|}
					\hline
					\multicolumn{2}{|c|}{\textbf{Caso de uso: PI\_CU1. Interceptar petición.}} \\
					\hline
